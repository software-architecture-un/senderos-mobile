...
[assembly: ExportRenderer(typeof(SignupTitleLabel), typeof(SignupTitleLabelRenderer))]
namespace SenderosMobile.Droid
{
    class SignupTitleLabelRenderer : LabelRenderer
    {
        public SignupTitleLabelRenderer(Context context) : base(context)
        {
        }
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.Label> e)
        {
            ...
            if (e.OldElement == null)
            {
                ...
                Control.SetTextSize(Android.Util.ComplexUnitType.Sp, 32); // Tamaño de la letra del Entry
