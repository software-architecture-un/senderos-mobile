...
[assembly: ExportRenderer(typeof(SignupPasswordEntry), typeof(SignupPasswordEntryRenderer))]
namespace SenderosMobile.Droid
{
    class SignupPasswordEntryRenderer : EntryRenderer
    {
        public SignupPasswordEntryRenderer(Context context) : base(context)
        {
        }
