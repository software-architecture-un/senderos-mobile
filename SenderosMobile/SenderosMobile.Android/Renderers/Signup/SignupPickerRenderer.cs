...
[assembly: ExportRenderer(typeof(SignupPicker), typeof(SignupPickerRenderer))]
namespace SenderosMobile.Droid
{
    class SignupPickerRenderer : PickerRenderer
    {
        public SignupPickerRenderer(Context context) : base(context)
        {
        }
