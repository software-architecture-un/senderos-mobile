...
[assembly: ExportRenderer(typeof(DeleteAccountLabel), typeof(DeleteAccountLabelRenderer))]
namespace SenderosMobile.Droid
{
    class DeleteAccountLabelRenderer : LabelRenderer
    {
        public DeleteAccountLabelRenderer(Context context) : base(context)
        {
        }
