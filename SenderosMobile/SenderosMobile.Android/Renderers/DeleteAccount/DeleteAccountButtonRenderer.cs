...
[assembly: ExportRenderer(typeof(DeleteAccountButton), typeof(DeleteAccountButtonRenderer))]
namespace SenderosMobile.Droid
{
    class DeleteAccountButtonRenderer : ButtonRenderer
    {
        public DeleteAccountButtonRenderer(Context context) : base(context)
        {
        }
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.Button> e)
        {
            ...
            if (e.OldElement == null)
            {
                ...
                Control.SetTextColor(Android.Graphics.Color.Rgb(242, 236, 249)); // Selecciona el color del texto de Button activado (#F2ECEF)
