...
[assembly: ExportRenderer(typeof(DeleteAccountPasswordEntry), typeof(DeleteAccountPasswordEntryRenderer))]
namespace SenderosMobile.Droid
{
    class DeleteAccountPasswordEntryRenderer : EntryRenderer
    {
        public DeleteAccountPasswordEntryRenderer(Context context) : base(context)
        {
        }
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.Entry> e)
        {
            ...
            if (e.OldElement == null)
            {
                ...
                gradientDrawable.SetStroke(2, Android.Graphics.Color.Rgb(43, 48, 58)); // Selecciona el color del borde de Entry (#2B303A)
