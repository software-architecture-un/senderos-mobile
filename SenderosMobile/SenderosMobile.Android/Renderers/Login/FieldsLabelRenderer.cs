...
[assembly: ExportRenderer(typeof(FieldsLabel), typeof(FieldsLabelRenderer))]
namespace SenderosMobile.Droid
{
    class FieldsLabelRenderer : LabelRenderer
    {
        public FieldsLabelRenderer(Context context) : base(context)
        {
        }
